    ...
    <section className=" bg-gray-900">
      <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
          ...
          <div className="pt-6 mt-6 space-y-4 border-t  border-gray-700">
            <div>
              <Link
                data-aos="fade-right"
                href="#"
                className="inline-flex items-center text-base font-medium   text-purple-500 hover:text-purple-700"
              >
        ...
        <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
          <div>
            <svg
              className="w-10 h-10 mb-2 md:w-12 md:h-12 text-purple-500"
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <div>
            ...
            <h3 className="mb-2 text-2xl font-bold text-white">600M+ Users</h3>
            <p className="font-light  text-gray-400">
          ...
          <div>
            ...
            <p className="font-light  text-gray-400">Transactions per day</p>
          </div>
        </div>
      </div>
    </section>
