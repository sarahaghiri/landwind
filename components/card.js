...
const card = () => {
  return (
    <section id="FEACHER" className=" bg-gray-900">
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        ...
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div className="flex flex-col max-w-lg p-6 mx-auto text-center  border  rounded-lg shadow border-gray-600 xl:p-8 bg-gray-800 text-white">
            ...
            <Link
              href="#"
              className=" bg-purple-600 hover:bg-purple-700 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center text-white  focus:ring-purple-900"
            >
              Get started
            </Link>
          </div>
